...
export function StepContent({
  ...
  const CodeBlock = ({
    ...
    <div className="relative bg-gray-900 rounded-lg p-4 font-mono text-sm border">
      {title && (
        <div className="text-gray-400 text-xs mb-2 font-semibold">{title}</div>
      )}
      <Button
        size="sm"
        variant="ghost"
        ...
        return (
          <div>
            <p className="text-gray-600 mb-6">
              Install and configure the required web browser for optimal
              compatibility with the AttendancePlus System.
            </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Download and install the latest version of Google Chrome for
                    optimal compatibility.
                  </p>
                  <ExternalLinkButton href="https://www.google.com/chrome/">
...
Start-Process -FilePath "ChromeSetup.exe" -ArgumentList "/silent /install" -Wait`}
          ...
          <div>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Set up required port bindings for all AttendancePlus
                    services.
                  </p>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm text-blue-800">
                      <div>
                        • Intervention API:{" "}
                        <code className="bg-blue-100 px-1 rounded">7189</code>
                      </div>
                      <div>
                        • Analysis API:{" "}
                        <code className="bg-blue-100 px-1 rounded">7296</code>
                      </div>
                      <div>
                        • Administration:{" "}
                        <code className="bg-blue-100 px-1 rounded">7239</code>
                      </div>
                      <div>
                        • Court Management:{" "}
                        <code className="bg-blue-100 px-1 rounded">7007</code>
                      </div>
                      <div>
                        • Identity API:{" "}
                        <code className="bg-blue-100 px-1 rounded">7206</code>
                      </div>
                      <div>
                        • SentLetter API:{" "}
                        <code className="bg-blue-100 px-1 rounded">7101</code>
                      </div>
                      <div>
                        • LetterDispatch API:{" "}
                        <code className="bg-blue-100 px-1 rounded">7119</code>
                      </div>
                      <div>
                        • MessageHub API:{" "}
                        <code className="bg-blue-100 px-1 rounded">7120</code>
                      </div>
                      <div>
                        • Miscellaneous:{" "}
                        <code className="bg-blue-100 px-1 rounded">7061</code>
                      </div>
                      <div>
                        • Gateway:{" "}
                        <code className="bg-blue-100 px-1 rounded">443</code>
                      </div>
                      <div>
                        • Angular Web:{" "}
                        <code className="bg-blue-100 px-1 rounded">443</code>
                ...
                <div className="space-y-4">
                  <Alert className="bg-red-50 border-red-200">
                    ...
                    <AlertDescription className="text-red-800">
                      <strong>CRITICAL:</strong> .NET CLR Version MUST be "No
                      Managed Code" and Identity MUST be "LocalSystem"
                    </AlertDescription>
                  </Alert>
      ...
      case "dotnet":
        return (
          <div>
            <p className="text-gray-600 mb-6">
              Install .NET 8 SDK and Hosting Bundle for the AttendancePlus
              System.
            </p>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Download and install the .NET 8 SDK and Hosting Bundle.
                  </p>
...
Start-Process -FilePath "dotnet-hosting.exe" -ArgumentList "/quiet" -Wait`}
                  ...
                  <Alert className="bg-blue-50 border-blue-200">
                    ...
                    <AlertDescription className="text-blue-800">
                      Install both SDK (development) and Hosting Bundle
                      (production). Hosting Bundle is required for IIS.
                    </AlertDescription>
                  </Alert>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CodeBlock title="Check .NET Version">
                      dotnet --version
                    </CodeBlock>
      ...
      case "rabbitmq":
        return (
          <div>
            <p className="text-gray-600 mb-6">
              Install and configure RabbitMQ message broker for the
              AttendancePlus System.
            </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CodeBlock title="Default Installation Path">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <CodeBlock title="Check Erlang Version">
                      erl -version
                    </CodeBlock>
                  </div>
                  ...
                  <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                    ...
                    <ul className="text-sm text-green-800 space-y-1">
                      <li>✅ RabbitMQ 4.3.1</li>
                      <li>✅ Erlang 27.3.4.13</li>
                      <li>
                        📁 Database Location:
                        <code className="ml-1">
                          C:\Users\{"{user}"}\AppData\Roaming\RabbitMQ\db
                        </code>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CodeBlock title="RabbitMQ Installation">
...
sc query RabbitMQ`}
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Enable the RabbitMQ management plugin for web-based
                    administration.
                  </p>
...
rabbitmqctl start_app`}
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Access the RabbitMQ management interface to verify
                    installation.
                  </p>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <div className="text-sm text-green-800">
                      <div>
                        Username:{" "}
                        <code className="bg-green-100 px-1 rounded">guest</code>
                      </div>
                      <div>
                        Password:{" "}
                        <code className="bg-green-100 px-1 rounded">guest</code>
...
rabbitmqctl set_permissions -p / attendanceplus ".*" ".*" ".*"`}
      ...
      case "mongodb":
        return (
          <div>
            <p className="text-gray-600 mb-6">
              Install and configure MongoDB database with replica set for the
              AttendancePlus System.
            </p>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Download all required MongoDB components.
                  </p>
...
C:\\data\\db\\`}
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Update MongoDB configuration file to enable replica set
                    functionality.
                  </p>
                  ...
                  <div className="space-y-2">
                    ...
                    <CodeBlock title="mongod.cfg Path">
  ...
  replSetName: "rs0"`}
                  ...
                  <Alert className="bg-blue-50 border-blue-200">
                    <Info className="h-4 w-4 text-blue-600" />
                    <AlertDescription className="text-blue-800">
                      Replica sets are required for MongoDB transactions used by
                      AttendancePlus System.
                    </AlertDescription>
                  </Alert>
                </div>
...
net start MongoDB`}
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Initialize the replica set using MongoDB shell commands.
                  </p>
...
rs.status()`}
                  ...
                  <Alert className="bg-green-50 border-green-200">
                    ...
                    <AlertDescription className="text-green-800">
                      The rs.status() command should show the replica set as
                      "PRIMARY" when successful.
                    </AlertDescription>
                  </Alert>
                </div>
        ...
        return (
          <div>
            <p className="text-gray-600 mb-6 text-lg">
              Install and configure SQL Server for the AttendancePlus System
              database.
            </p>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Download SQL Server 2019 or later with required features.
                  </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <Alert className="bg-amber-50 border-amber-200">
                    <AlertTriangle className="h-4 w-4 text-amber-600" />
                    <AlertDescription className="text-amber-800">
                      Choose "Mixed Mode" authentication during installation and
...
sqlcmd -S localhost -U sa -P YourPassword`}
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Create the main database for AttendancePlus System.
                  </p>
          ...
          <div>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p className="text-gray-700">
                    Extract and prepare the AttendancePlus API files for
                    deployment.
                  </p>
...
cd "C:\\RK12.AttPlus.Solution.US"`}
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 border">
                    <h4 className="font-semibold text-gray-800 mb-3">
                      Required API Services with Updated Ports:
                    </h4>
        ...
        return (
          <div className="text-center py-12">
            <h2 className="text-2xl font-bold mb-4">
              Welcome to AttendancePlus Installation
            </h2>
            <p className="text-gray-600">
              Select a section from the sidebar to begin the installation
              process.
            </p>
          </div>
        );
