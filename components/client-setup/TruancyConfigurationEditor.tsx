            ...
            <>
              ...
              <div className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-400 mb-2">CampusType</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-400 mb-2">CategoryTitle (Auto-synced)</label>
                    <Input
                      value={baseProperties.CategoryTitle}
                      disabled
                      className="bg-slate-700 border-slate-600 text-slate-400 opacity-75"
                    />
                  </div>

                  <div>
                    <label className="block text-xs font-semibold text-slate-400 mb-2">IsConsecutive</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-400 mb-2">OccuranceNumber</label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-400 mb-2">TrauncySequence</label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-400 mb-2">GracePeriod</label>
                    <Input
                      type="number"
                  ...
                  <div className="lg:col-span-2">
                    <label className="block text-xs font-semibold text-slate-400 mb-2">ChooseAction</label>
                    <Input
                    ...
                    <table className="w-full text-sm">
                      <thead className="bg-slate-900 border-b border-slate-700">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left font-semibold text-slate-300">Period</th>
                          <th className="px-4 py-3 text-center font-semibold text-slate-300">Occ</th>
                          <th className="px-4 py-3 text-center font-semibold text-slate-300">Seq</th>
                          <th className="px-4 py-3 text-center font-semibold text-slate-300">Grace</th>
                      ...
                      <tbody>
                        {records.map((record, idx) => (
                          <tr key={record.id} className="border-b border-slate-700 hover:bg-slate-700/50 transition-colors">
                            ...
                            <td className="px-4 py-3 text-white font-medium text-sm">{record.Action}</td>
                            <td className="px-4 py-3 text-slate-400 text-sm">{record.Category}</td>
                            <td className="px-4 py-3 text-slate-400 text-sm">{record.Period}</td>
                            <td className="px-4 py-3 text-center font-semibold text-white">{record.OccuranceNumber}</td>
                            <td className="px-4 py-3 text-center font-semibold text-white">{record.TrauncySequence}</td>
                            <td className="px-4 py-3 text-center font-semibold text-white">{record.GracePeriod}</td>
                  ...
                  {editingId && (
                    <div className="bg-slate-900 p-6 border-t border-slate-700">
                      {records.find(r => r.id === editingId) && (
                        <div>
                          <h4 className="font-semibold text-white mb-4">Edit Record</h4>
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div>
                              <label className="block text-xs font-semibold text-slate-400 mb-2">Period</label>
                              <select
