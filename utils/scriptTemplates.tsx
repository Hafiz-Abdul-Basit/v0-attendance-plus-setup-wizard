...
export const scriptTemplates = {
  ...
  sqlServer: (): ScriptSection => ({
    title: 'SQL Server 2022 Developer Installation',
    description: 'Install SQL Server 2022 Developer Edition with latest tools',
    commands: [
      '# ===== SQL SERVER 2022 INSTALLATION =====',
      `$SqlServerPath = "${DOWNLOADS_PATH}\\sqlserver2022.exe"`,
      '$SqlServerUrl = "https://aka.ms/sssdt-download"',
      'Write-Host "Downloading SQL Server 2022 Developer Edition..."',
      'Invoke-WebRequest -Uri $SqlServerUrl -OutFile $SqlServerPath -ErrorAction Stop',
      'Write-Host "Starting SQL Server 2022 installation..."',
      'Write-Host "Please complete the SQL Server installation wizard"',
      'Write-Host "Recommended: Enable Mixed Authentication mode during setup"',
      'Start-Process -FilePath $SqlServerPath -Wait',
      'Write-Host "SQL Server 2022 installation in progress..."',
      'Write-Host "This may take 15-30 minutes. Please wait..."',
      'Start-Sleep -Seconds 30',
      'Write-Host "Installation wizard closed. Finalizing setup..."',
